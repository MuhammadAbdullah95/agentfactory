...
### Advanced Version (With Functions and Error Handling)

If you're comfortable with functions, here's a more advanced version:

```python
# Advanced Calculator with Functions and Validation
import keyword
...
def demonstrate_operators(num1: float, num2: float) -> None:
    """Show all operator types with num1 and num2"""
    print("\n" + "=" * 50)
    print("COMPREHENSIVE OPERATOR DEMONSTRATION")
    print("=" * 50)
    ...
    cond1: bool = num1 > 0
    cond2: bool = num2 > 0
    print(f"Both positive: ({num1} > 0) and ({num2} > 0) = {cond1 and cond2}")
    print(f"Either positive: ({num1} > 0) or ({num2} > 0) = {cond1 or cond2}")
    print(f"First not positive: not ({num1} > 0) = {not cond1}")
    ...
    total += num2
    print(f"After += {num2}: total = {total}")
    total *= 0.5
    print(f"After *= 0.5: total = {total}")

    # Type validation
    print("\n--- TYPE VALIDATION ---")
    print(f"num1 type: {type(num1)}")
    print(f"num2 type: {type(num2)}")
    print(f"(num1 + num2) type: {type(num1 + num2)}")
    print(f"(num1 == num2) type: {type(num1 == num2)}")

def show_keyword_awareness() -> None:
    """Demonstrate keyword awareness"""
    print("\n--- KEYWORD AWARENESS ---")
    print(f"Total Python keywords: {len(keyword.kwlist)}")
    print(f"Examples: {keyword.kwlist[:10]}...")

    test_names: list[str] = ["count", "for", "data", "while", "result"]
    print("\nChecking variable names:")
    for name in test_names:
        status: str = "RESERVED" if keyword.iskeyword(name) else "OK"
        print(f"  '{name}': {status}")
...
if __name__ == "__main__":
    ...
    print("Demonstrates all operator types from Chapter 15")
    print("=" * 50)

    num1: float = safe_number_input("\nEnter first number: ")
    num2: float = safe_number_input("Enter second number: ")

    demonstrate_operators(num1, num2)
    show_keyword_awareness()
...
Both versions demonstrate all four operator types plus validation and keyword awareness. Choose whichever matches your current comfort level.
