---
sidebar_position: 8
title: "Chapter 12: Meet Your First AI Employee Quiz"
...
# Chapter 12: Meet Your First AI Employee Quiz
...
<Quiz
title="Chapter 12: Meet Your First AI Employee Assessment"
...
{
question: "You've completed Chapter 12 and are preparing for Chapter 13, where you'll build your own AI Employee. You're drafting a specification. Which approach to specification writing produces the best results?",
options: [
...
- What tasks should my employee handle directly? ___
- What tasks should it delegate to a coding agent? ___
- What productivity tools should it connect to? ___
```
...
You started Chapter 12 with a question: what is an AI Employee? You end with an answer that goes deeper than you expected. An AI Employee is not just a chatbot that does more. It is an autonomous system built on 6 universal patterns, with real security implications and unsolved problems that the industry is still working through.
