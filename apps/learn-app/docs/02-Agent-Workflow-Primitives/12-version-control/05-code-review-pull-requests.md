...
A **Pull Request (PR)** is a GitHub feature that lets you propose merging code from one branch into another (usually main). It's like saying: _"Here are my changes. Please review them before merging."_
