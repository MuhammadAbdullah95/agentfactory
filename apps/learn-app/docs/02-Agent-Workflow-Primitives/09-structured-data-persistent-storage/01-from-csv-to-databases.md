...
lesson: 0
duration_minutes: 20
description: "Identify exactly when Chapter 8 workflows should escalate to schema + relational storage"
...
learning_objectives:
  - objective: "Diagnose when Chapter 8 patterns should escalate to SQL"
    proficiency_level: "A1"
    bloom_level: "Analyze"
...
*Source: ["Testing if bash is all you need"](https://vercel.com/blog/testing-if-bash-is-all-you-need), Vercel Engineering Blog / Braintrust, 2025.*
:::
...
| Situation | Stay with Chapter 8 pattern | Escalate to Chapter 9 pattern |
|---|---|---|
