### Core Concept
Chapter 9 begins when evolving query demands make loop-based CSV logic too brittle. Schema and relational constraints become the next required primitive.

### Continuity Bridge
- Chapter 7: Bash for file operations and orchestration
- Chapter 8: Python for deterministic parsing and computation
- Chapter 9: SQLAlchemy + PostgreSQL for persistent relational truth
