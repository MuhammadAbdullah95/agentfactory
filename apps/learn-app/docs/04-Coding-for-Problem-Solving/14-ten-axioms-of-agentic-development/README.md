...
In [Chapter 6](/docs/General-Agents-Foundations/seven-principles/code-as-universal-interface), you learned that code is the universal interface — general agents that write code can solve any computational problem. That principle has only grown stronger.
