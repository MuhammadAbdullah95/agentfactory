...
In [Chapter 6](../../01-General-Agents-Foundations/06-seven-principles/02-code-as-universal-interface.md), you learned that code is the universal interface — general agents that write code can solve any computational problem. That principle has only grown stronger.

Consider what is happening across every industry. Need a presentation? AI generates code that produces the slides. Need a document? AI generates code that formats the content. Need a design? Figma's *Code to Canvas* feature, launched in partnership with Anthropic in February 2026, converts code generated by AI tools like Claude Code into fully editable Figma designs ([CNBC, 2026](https://www.cnbc.com/2026/02/17/figma-anthropic-ai-code-designs.html)). Not design-to-code, but **code-to-design**. The direction has reversed.
