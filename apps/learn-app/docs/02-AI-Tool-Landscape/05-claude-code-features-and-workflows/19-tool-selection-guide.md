...
prerequisites:
  - "Lessons 01-14: Familiarity with all tool types"
---
...
*   **Analysis:** Does it need external data? Yes (Jira).
...
*   **Selection:** **CLAUDE.md** (if global) or **Skill** (if specific to one task). Likely **CLAUDE.md** if it applies everywhere.
...
*   **Analysis:** Is it complex? Yes. Does it need focus? Yes.
*   **Selection:** **Subagent**. Create a "Researcher" subagent equipped with Browser MCP and specific research skills.

### Scenario D: "Stop Claude from committing secrets/API keys to git."
*   **Analysis:** Is it safety/validation? Yes.
*   **Selection:** **Hook**. A `pre-git-commit` hook.
