...
layer_1_foundation: "Lesson 08: Manual skill creation (SKILL.md structure, descriptions, procedures)"
...
# Prerequisites
prerequisites:
  - "Lesson 08: Building Your Own Skills (understand SKILL.md structure)"
...
In Lesson 08, you learned to create individual skills manually. You noticed the pattern: every skill needs the same structure (YAML frontmatter, triggers, procedures, quality criteria).

The Skill Factory encodes this pattern once. Instead of spending 30 minutes crafting a skill by hand, you use the factory to generate consistent, high-quality skills in minutes.

That's the power of a meta-skill.
