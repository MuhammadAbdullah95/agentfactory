...
learning_objectives:
  - objective: "Identify the key events in OpenClaw's rise from first commit (November 24, 2025) through 208,000 GitHub stars and the transition to a foundation (February 2026)"
...
In late January 2026, a weekend project by Peter Steinberger -- the Austrian engineer who founded PSPDFKit and spent 13 years building developer tools used by nearly a billion people -- went viral in a way the open-source world had rarely seen. His AI agent, originally called Clawdbot, accumulated GitHub stars at unprecedented speed. By mid-February 2026, the project (now renamed OpenClaw after an Anthropic trademark dispute) had crossed 208,000 stars, making it one of the fastest-growing repositories in GitHub history.
...
**By February 16, 2026**: The project has 208,000 GitHub stars. For context, it took React (Meta's UI framework) over a decade to reach 230,000 stars. OpenClaw did most of that distance in under three months.
...
208,000 stars means hundreds of thousands of developers looked at OpenClaw and said: "I want this." The viral loop through messaging apps -- where you can demo the product by simply forwarding a conversation -- created adoption speed that traditional developer tools cannot match.
...
Peter Steinberger's personal commitment drove OpenClaw's explosive growth. He shipped code daily, responded to issues personally, and shaped the project's direction. That commitment was also a vulnerability: one person as the primary architect of a 208,000-star project is a significant bus factor risk.
...
```
OpenClaw reached 208,000 GitHub stars in under 3 months. React took
