...
Throughout this chapter, you created skills (Lesson 8), configured subagents (Lesson 9), connected MCP servers (Lesson 10), and set up hooks (Lesson 13). Packaging these as a plugin lets you share them with teammates or use them across all your projects.
...
{
  "name": "skills-lab",
  "description": "Practice skills from Panaversity tutorials",
  "version": "1.0.0",
  "author": {
    "name": "Your Name"
  }
