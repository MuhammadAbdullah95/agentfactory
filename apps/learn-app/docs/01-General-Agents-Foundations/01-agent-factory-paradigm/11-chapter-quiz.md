...
options: ["Ability to customize solutions", "Lowest price guarantee", "Domain expertise", "Outcome-based pricing models"],
correctOption: 1,
...
options: ["Agentic AI Enabler", "Packaged Agent Implementer", "Custom Agent Developer", "End-to-End Workflow Disruptor"],
correctOption: 2,
...
options: ["Outcome-based pricing is always cheaper", "It aligns provider incentives with measurable business results and reduces risk", "It requires less contract negotiation", "It eliminates the need for project management"],
correctOption: 1,
