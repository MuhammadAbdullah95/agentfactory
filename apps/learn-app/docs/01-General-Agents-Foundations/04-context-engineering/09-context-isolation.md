...
cognitive_load:
  new_concepts: 6
  assessment: "6 concepts (dirty slate problem, clean context pattern, orchestrator synthesis, three subagent patterns, context amnesia workarounds, tool access control) within B1 range (5-7)"
