...
**[Download Computation Exercises (ZIP)](https://github.com/panaversity/claude-code-computation-exercises/releases/latest/download/computation-exercises.zip)**
...
If the download link doesn't work, visit the [repository releases page](https://github.com/panaversity/claude-code-computation-exercises/releases) directly.
:::
