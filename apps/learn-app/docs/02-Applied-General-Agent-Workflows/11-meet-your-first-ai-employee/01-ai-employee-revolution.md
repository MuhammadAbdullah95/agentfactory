...
skills:
  - name: "AI Employee Mental Model"
    ...
    measurable_at_this_level: "Can explain the difference between AI chatbots and AI Employees, articulating why autonomous action distinguishes the paradigm shift"
  ...
  - name: "Agent Adoption Context"
    ...
    measurable_at_this_level: "Can describe the historical significance of OpenClaw's viral moment and why it validated the AI Employee concept"

learning_objectives:
  - objective: "Understand the historical significance of OpenClaw's viral moment"
    proficiency_level: "A2"
    bloom_level: "Understand"
    assessment_method: "Explain in own words why OpenClaw achieving 165,000+ GitHub stars in weeks matters for the AI Employee paradigm"
  - objective: "Distinguish AI Employees from AI chatbots"
    proficiency_level: "A2"
    bloom_level: "Analyze"
    assessment_method: "Compare/contrast exercise: given descriptions of AI interactions, identify which demonstrate AI Employee vs chatbot patterns"
  - objective: "Identify potential AI Employee use cases in your domain"
    proficiency_level: "B1"
    bloom_level: "Apply"
    assessment_method: "Try With AI exercises where student explores personal use cases"

cognitive_load:
  new_concepts: 4
  assessment: "Moderate - new mental model (AI Employee vs chatbot), historical context (OpenClaw timeline), industry validation (reactions and adoption), personal application. Within A2 range (5-7) for conceptual content."

differentiation:
  extension_for_advanced: "Research the security concerns raised by Gary Marcus and the Citizen Lab, and form your own opinion on the risk/reward tradeoff of autonomous agents"
