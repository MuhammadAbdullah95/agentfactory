        ...
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pana-500"
            />
          </div>
          <select className="px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pana-500">
                ...
                <td className="px-4 py-4">
                  <div className="flex items-center gap-3">
                    {org.logo ? (
                      ...
                      <div className="w-10 h-10 bg-gradient-to-br from-pana-500 to-pana-600 rounded-lg flex items-center justify-center text-white font-semibold text-sm">
